  ...
  const features = [
    {
      ...
      description:
        "Our spoofer permanently changes your hardware IDs, ensuring long-term protection against HWID bans and VPN kicks.",
    },
    {
      icon: Zap,
      title: "Undetectable Technology",
      description:
        "Advanced spoofing methods that remain undetected by anti-cheat systems and hardware scanners.",
    },
    {
      icon: Clock,
      title: "24/7 Elite Support",
      description:
        "Our dedicated team provides around-the-clock assistance for any questions or issues you might have.",
    },
    {
      icon: Database,
      title: "Secure Implementation",
      description:
        "Fynze's technology is designed with security in mind, ensuring your system remains protected and stable.",
    },
    {
      icon: Award,
      title: "Regular Updates",
      description:
        "Continuous updates to stay ahead of detection methods and ensure permanent effectiveness.",
    },
    {
      icon: Cpu,
      title: "Instant Activation",
      description:
        "One-click activation gets you protected immediately with no complicated setup process.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "An HWID (Hardware ID) Spoofer is a tool that changes how your computer's hardware is identified by software and online services. You might need it if you've received a hardware ban from a service, game, or simply want to protect your privacy when using VPN services that might otherwise get detected and result in kicks or restrictions.",
    },
    {
      value: "faq-2",
    ...
    },
    {
      ...
      answer:
        "Yes! HWID Spoofers are legal tools for privacy protection. They function similarly to other privacy tools like VPNs or browser privacy extensions. Our software is designed for legitimate privacy enhancement and protecting users from unfair restrictions. We're proud to offer a solution that helps users maintain their digital rights and privacy.",
    },
    {
      value: "faq-4",
      question: 'What makes Fynze\'s HWID Spoofer "permanent"?',
      answer:
        "Unlike temporary solutions that need to be reapplied after each reboot, our HWID Spoofer makes permanent modifications to how your system reports hardware identifiers. These changes persist through system updates and reboots. Additionally, we provide lifetime updates to ensure continued compatibility with evolving detection methods.",
    },
    {
      value: "faq-5",
  ...
  return (
    <div className="flex min-h-screen gradient-bg-dark">
      ...
      <main className="flex-1 lg:ml-16">
        ...
        <section
          id="hero"
          className="relative overflow-hidden grid-pattern py-16 lg:py-24"
        >
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
              <div className="lg:w-1/2 text-center lg:text-left">
                ...
                <p className="mt-6 text-lg text-slate-300 max-w-2xl mx-auto lg:mx-0 reveal-element reveal-left">
                  ...
                  . Our cutting-edge technology provides unmatched protection
                  with 24/7 elite support.
                </p>
                  ...
                  >
                    ...
                    <div className="relative z-10 py-3 px-7 rounded-lg bg-transparent border border-blue-600/50 group-hover:border-blue-500 transition-all duration-300">
                      <span className="font-medium text-blue-400 group-hover:text-blue-300 transition-colors duration-300 flex items-center">
                        ...
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-5 w-5 ml-2 transform group-hover:translate-y-1 transition-transform duration-300"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
        ...
        <section
          id="quote"
          className="py-14 relative overflow-hidden bg-gradient-to-b from-slate-900 to-slate-950"
        >
          <div className="absolute inset-0 opacity-5">
            <img src={logoBg} alt="" className="w-full h-full object-cover" />
          </div>
            ...
            <div className="reveal-element reveal-scale">
              <p className="text-xl md:text-2xl font-medium text-slate-300 italic">
                ...
                <span className="gradient-text font-bold">
                  {" "}
                  Fynze is the only solution that permanently changes your HWID
                </span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-16 reveal-element reveal-bottom">
              ...
              <p className="mt-4 text-slate-400 max-w-2xl mx-auto">
                Our HWID Spoofer provides comprehensive protection against
                hardware ID tracking and bans with our advanced technology
              </p>
            </div>
        ...
        <section
          id="comparison"
          className="py-16 relative overflow-hidden bg-gradient-to-b from-slate-900 to-slate-950"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-950/10 via-transparent to-indigo-950/10"></div>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
            <div className="text-center mb-16 reveal-element reveal-bottom">
              ...
              <p className="mt-4 text-slate-400 max-w-2xl mx-auto">
                See why our technology outperforms competitors with our
                permanent hardware ID modification
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16">
              ...
              <div className="relative p-6 rounded-xl bg-gradient-to-b from-slate-800/30 to-slate-900/70 border border-slate-700 reveal-element reveal-left">
                ...
                <h3 className="text-xl font-bold text-slate-200 mb-6 mt-2">
                  Temporary Masking Solutions
                </h3>
                ...
                <ul className="space-y-5">
                  <li className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-slate-300">
                        Only Mask Hardware IDs
                      </h4>
                      <p className="text-sm text-slate-400 mt-1">
                        Simply hide identifiers temporarily rather than
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400 mt-1">
                        Protection is lost after system restart, requiring
                        reapplication
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-slate-300">
                        Detectable by Advanced Scans
                      </h4>
                      <p className="text-sm text-slate-400 mt-1">
                        Modern anti-cheat systems can detect masking attempts
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400 mt-1">
                        Often provide minimal documentation and customer
                        assistance
                      </p>
                    </div>
                  </li>
              ...
              <div className="relative p-6 rounded-xl bg-gradient-to-b from-blue-950/40 to-slate-900/90 border border-blue-800/30 reveal-element reveal-right">
                ...
                <div className="relative">
                  <h3 className="text-xl font-bold text-blue-200 mb-6 mt-2">
                  ...
                  <ul className="space-y-5">
                    <li className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-medium text-blue-100">
                          Permanently Changes Hardware IDs
                        </h4>
                        <p className="text-sm text-blue-200/80 mt-1">
                          Uses advanced technology to modify your hardware
                          identifiers at the system level
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-200/80 mt-1">
                          Changes persist through reboots, Windows updates, and
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-200/80 mt-1">
                          Makes your system appear genuinely new to all
                          detection methods
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-200/80 mt-1">
                          Includes comprehensive guides and 24/7 support from
                          hardware ID experts
                        </p>
                      </div>
                    </li>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="lg:w-1/2 reveal-element reveal-right">
                ...
                <p className="mt-4 text-slate-300">
                  Our intuitive interface lets you take control of your hardware
                  identity with just a few clicks. Designed for both beginners
                  and advanced users, Fynze HWID Spoofer delivers powerful
                  protection without complicated setup.
                </p>
                ...
                <div className="mt-8 space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium gradient-text-blue-cyan">
                        Complete Protection
                      </h3>
                      <p className="text-slate-400">
                        Modifies all hardware identifiers including CPU, GPU,
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-400">
                        Changes take effect immediately without requiring
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-400">
                        24/7 expert assistance for any questions or issues you
                        might encounter
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto relative">
              ...
              <div className="reveal-element reveal-left">
                <div className="relative p-6 rounded-xl bg-gradient-to-b from-slate-800/30 to-slate-900/70 border border-slate-700 hover:border-slate-600 transition-all duration-500 hover:shadow-md hover:shadow-blue-900/20 group">
                  <div className="mb-4">
                    <h3 className="text-xl font-bold text-slate-100 group-hover:text-slate-50 transition-colors duration-300">
                      24H One-Time Plan
                    </h3>
                  ...
                  <ul className="mt-6 space-y-4">
                    <li className="flex">
                      ...
                      <span className="text-slate-300">
                        Full HWID spoofing capabilities
                      </span>
                    </li>
                    <li className="flex">
                      <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500/10 flex items-center justify-center mr-2">
                      ...
                      <span className="text-slate-300">
                        Same spoofing technology as lifetime
                      </span>
                    </li>
                    <li className="flex">
                      <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500/10 flex items-center justify-center mr-2">
                  ...
                  <div className="mt-8">
                    ...
                    >
                      ...
                      <span className="relative z-10 text-blue-300 group-hover/btn:text-blue-200 transition-colors duration-300 flex items-center justify-center">
                        ...
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4 ml-2 transform group-hover/btn:translate-x-1 transition-transform duration-300"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
              ...
              <div className="reveal-element reveal-right">
                <div className="relative p-8 rounded-xl bg-gradient-to-b from-blue-950/40 to-slate-900/90 border border-blue-800/30 group hover:border-blue-700/40 transition-all duration-500 hover:shadow-lg hover:shadow-blue-900/30 transform">
                  ...
                  <div className="relative">
                    <div className="mb-5">
                      <h3 className="text-2xl font-bold text-slate-50 group-hover:text-white transition-colors duration-300">
                        Lifetime Plan
                      </h3>
                    ...
                    <ul className="mt-7 space-y-4">
                      ...
                      <li className="flex">
                        ...
                        <span className="text-slate-200">
                          Full hardware ID mask customization
                        </span>
                      </li>
                    </ul>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="reveal-element reveal-scale bg-gradient-to-b from-slate-800/50 to-slate-900/50 p-6 rounded-xl border border-slate-800 hover:border-blue-500/30 transition-all duration-300 group">
                ...
                <h3 className="text-xl font-semibold mb-3 gradient-text-blue-cyan">
                  Deep Hardware Modification
                </h3>
                <p className="text-slate-300">
                  Our technology modifies your hardware IDs at the firmware
                  level, creating permanent changes that persist through updates
                  and reboots.
                </p>
              ...
              <div className="reveal-element reveal-scale bg-gradient-to-b from-slate-800/50 to-slate-900/50 p-6 rounded-xl border border-slate-800 hover:border-blue-500/30 transition-all duration-300 group">
                ...
                <h3 className="text-xl font-semibold mb-3 gradient-text-blue-cyan">
                  Intelligent HWID Randomization
                </h3>
                <p className="text-slate-300">
                  Our AI-driven algorithm creates believable, consistent
                  hardware profiles that appear genuine to even the most
              ...
              <div className="reveal-element reveal-scale bg-gradient-to-b from-slate-800/50 to-slate-900/50 p-6 rounded-xl border border-slate-800 hover:border-blue-500/30 transition-all duration-300 group">
                ...
                <p className="text-slate-300">
                  All your hardware data is secured with future-proof encryption
                  that protects against even next-generation cracking attempts.
                </p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 relative">
            <div className="text-center reveal-element reveal-scale">
              ...
              <p className="mt-4 text-slate-300 max-w-2xl mx-auto">
                Join thousands of satisfied users who trust Fynze for their HWID
                spoofing needs. Our solution includes{" "}
                <span className="gradient-text font-semibold">
                  insane, detailed documentation
                </span>{" "}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <h3 className="text-lg font-bold gradient-text-blue-cyan">
                  Fynze Services
                </h3>
